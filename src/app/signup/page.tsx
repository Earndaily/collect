...
function SignUpForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      await signInWithGoogle(referrerUid);
      router.push('/pay-activation');
    } catch (err: any) {
        ...
        <Card>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="mt-4 w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center justify-center gap-2 text-gray-900 dark:text-white"
            >
